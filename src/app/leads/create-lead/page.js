...
//   CC: ['Option 1', 'Option 2'],
  ...
  leadSource: [' None', 'WalkIn', 'StudentReferral', 'Demo', 'WebSite', 'WebsiteChat', 'InboundCall', 'GoogleAdWords', 'FacebookAds',
         'GoogleMyBusiness', 'WhatsApp'],
  stack: ['LifeSkills', 'StudyAbroad', 'HR'],
  course: ['PublicSpeaking', 'PTE'],
};